  ...
  return (
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <aside className="hidden lg:block fixed inset-y-0 left-0 w-[320px] h-screen overflow-y-auto bg-white/70 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-r border-gray-200 p-3 sm:p-4">
          <div className="mb-3">
            <div className="relative">
              <input
                value={query}
