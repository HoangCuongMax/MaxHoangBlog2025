...
export default function PageContainer({ children, className = '', fullscreen = false, noBoxStyling = false, maxWidthClass = 'max-w-6xl' }: PageContainerProps) {
  if (fullscreen) {
  ...
  if (noBoxStyling) {
    ...
    return (
      <div className={`min-h-screen page-container ${className}`}>
        <div className={`${maxWidthClass} mx-auto px-4 pt-2 pb-3 sm:px-6 sm:pt-4 sm:pb-4 lg:px-8 lg:pt-6 lg:pb-6 md:text-[1.2em]`}>
          {children}
        </div>
      </div>
    )
  ...
  return (
    <div className={`min-h-screen page-container ${className}`}>
      ...
      <div className={`${maxWidthClass} mx-auto px-3 pt-4 pb-3 sm:px-6 sm:pt-6 sm:pb-4 lg:px-8 lg:pt-12 lg:pb-12 md:text-[1.2em]`}>
