export default function Footer() {
  return (
    <footer className="bg-[rgb(51,51,116)] text-white mt-16">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <h3 className="text-xl font-bold mb-2">Max Hoang</h3>
            <p className="text-white text-opacity-80 text-sm mb-4 text-center md:text-left">
              Digital Creator | AI & Marketing | Healthy Living
            </p>
            
            <p className="text-white text-opacity-70 text-xs mb-3 text-center md:text-left leading-relaxed">
              📍 Darwin, NT, Australia
            </p>
            
            <p className="text-white text-opacity-70 text-xs text-center md:text-left mb-4">
              🇻🇳 English & Vietnamese
            </p>

            <p className="italic text-white text-opacity-70 text-sm text-center md:text-left max-w-xs">
          ...
          <div className="flex flex-col items-center">
            <h4 className="text-sm font-bold mb-6 text-white opacity-90">QUICK LINKS</h4>
