  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 w-full h-full">
        <img
          src="https://cdn.builder.io/api/v1/image/assets%2Fb646c680cb1245e8b61dacef2f73503f%2Ffc6ddaf3050c46418cb5202daca39019?format=webp&width=1200"
      ...
      {/* Content */}
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-20 text-white">
          ...
          <div className="space-y-3 mb-10">
            ...
            <div className="flex items-start gap-3 p-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg border border-white border-opacity-20 hover:bg-opacity-20 transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-gray-200">$10k Prize Winner</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-4 bg-white bg-opacity-10 backdrop-blur-sm rounded-lg border border-white border-opacity-20 hover:bg-opacity-20 transition-all">
              ...
              <div>
                ...
                <p className="text-sm text-gray-200">Won 5 of 6 Challenges</p>
              </div>
            </div>
          </div>
